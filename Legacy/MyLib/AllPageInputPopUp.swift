...
class AllPageInputPopUp: NSObject {
    struct Constants {
...
extension AllPageInputPopUp {
    func setLayouts() {
        
        popUpView.addSubviews(titleLabel, messageLabel, rightImg)
        ...
        popUpView.addSubview(allPageTextField)
